...
bool Memory::Initialize() {
  ...
  REXSYS_INFO("Guest address space: {} MB mapped at {}",
              kGuestBackingLength >> 20, fmt::ptr(mapping_base_));
...
#if REX_PLATFORM_MAC || REX_PLATFORM_ANDROID
  // Direct MAP_FIXED probing can overwrite unrelated host mappings. Reserve
  // the entire range as a hint first and only install fixed alias views at a
  // base owned by this memory instance.
  void* reservation =
