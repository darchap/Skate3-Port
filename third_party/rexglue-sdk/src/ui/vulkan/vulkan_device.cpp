...
#if REX_PLATFORM_ANDROID
      // The Mali-G57 doesn't expose this feature. Skate 3's Android build
      // boots through the native scene renderer, which doesn't require
      // vertex-stage storage writes; keep the emulated fallback available
      // without enabling the unsupported feature below.
      REXLOG_WARN(
          "Vulkan device '{}' lacks vertexPipelineStoresAndAtomics; continuing "
